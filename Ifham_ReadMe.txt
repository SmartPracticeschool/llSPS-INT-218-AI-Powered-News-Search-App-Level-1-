AI Powered News Search Application (Level-1)
	BY - Ifham Ali

URL of news app created is https://ifhams-news-search-app.eu-gb.mybluemix.net/ui/#!/0?socketid=VXWjPfwEiqq6l2S9AAAB
...
Ifham_source_code.json file contains all the json code of node red flow.
